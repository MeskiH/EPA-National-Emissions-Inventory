...
png(filename = "C:/Users/mdibaba/Downloads/The DS Toolbox/EPA National Emissions Inventory/exdata_data_NEI_data/plot6.png", width = 480, height = 480, units = "px", bg = "white")
